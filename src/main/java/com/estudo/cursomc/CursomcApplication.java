...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//=========== Criação Clientes e Endereços
		
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com.br", "36378912377", TipoCliente.PESSOAFISICA);
